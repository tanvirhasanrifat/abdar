...
import 'package:abdar/widget/custombutton.dart';
import 'package:abdar/widget/textfeilds.dart';
...
class _UserFormState extends State<UserForm> {
  ...
  sendUserDataToDB()async{
    ...
    return _collectionRef.doc(currentUser!.email).set({
      ...
      (builder: (_)=>BottomNavController ()))).catchError((error)=>Fluttertoast.showToast(msg: "something is wrong. $error"));  }
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style:
                  TextStyle(fontSize: 22.sp, color: Mycolors.deep_orange),
                ),
                Text(
